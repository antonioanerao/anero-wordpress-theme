<form class="input-group md-form form-sm form-2 pl-0" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    <input placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', 'fancy-lab' ); ?>" value="<?php echo get_search_query(); ?>" name="s" class="form-control my-0 py-1 amber-border" type="search" aria-label="<?php _e('Search', 'anero') ?>">
