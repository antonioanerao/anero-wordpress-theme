...
<section class="footer-widgets">
	<div class="container">
		<div class="row">
			<?php if( is_active_sidebar( 'anero-sidebar-footer-1' ) ): ?>
				<div class="col-md-4 col-lg-4 col-12">
					<?php dynamic_sidebar( 'anero-sidebar-footer-1' ); ?>
				</div>
			<?php endif; ?>
			<?php if( is_active_sidebar( 'anero-sidebar-footer-2' ) ): ?>
				<div class="col-md-4 col-lg-4 col-12">
					<?php dynamic_sidebar( 'anero-sidebar-footer-2' ); ?>
				</div>
			<?php endif; ?>
			<?php if( is_active_sidebar( 'anero-sidebar-footer-3' ) ): ?>
				<div class="col-md-4 col-lg-4 col-12">
					<?php dynamic_sidebar( 'anero-sidebar-footer-3' ); ?>
				</div>
			<?php endif; ?>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="footer-menu col-lg-6 h-100 text-center text-lg-left my-auto">
				...
				wp_nav_menu(
					array(
						'theme_location'	=> 'anero_footer_menu',
						'depth'				=> 1,
					)
				);
				?>
				<p class="text-muted small mb-4 mb-lg-0"><br> <?php echo esc_html( get_theme_mod( 'set_copyright', __( 'Copyright X - All Rights Reserved', 'anero' ) ) ); ?></p>
			</div>
